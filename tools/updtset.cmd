...
set tileset_fork="D:\git\UndeadPeopleTileset_Unpacked_New_Version\dda"

::
:: 2. Set correct tileset folder name (e.g. UltimateCataclysm)

set def_tileset="MSX++UnDeadPeopleEdition_v2"

::
:: 3. Set path to compose.py file 

set script_dir="D:\git\UndeadPeopleTileset_Unpacked_New_Version\tools"

::
:: 4. Set path to the folder where to put the composed tileset (for future examination)

set composed_dir="D:\git\UndeadPeopleTileset_Unpacked_New_Version\compiled"

::
:: 5. Set path to CDDA game folder

set the_game_dir="D:\Games\cdda"
